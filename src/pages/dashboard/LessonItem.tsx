...
const LessonItem = ({ lesson }: LessonItemProps) => {
  return (
    <div
      key={lesson.id}
      className="bg-gradient-to-r from-indigo-100 to bg-purple-200 flex flex-col items-center p-3 rounded-lg shadow-md"
    >
      <img
        src={lesson.image}
        alt={lesson.title}
      ...
      <div className="flex flex-col w-full mt-2  text-center items-center">
        ...
        <p className="text-sm text-gray-700 line-clamp-2">{lesson.title}</p>
